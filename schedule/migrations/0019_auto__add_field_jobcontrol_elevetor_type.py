...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'schedule_jobcontrol', 'elevetor_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='job-con-elevetor-type', null=True, to=orm['schedule.ElevetorType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobControl.elevetor_type'
        db.delete_column(u'schedule_jobcontrol', 'elevetor_type_id')
