...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobControl.job_name'
        db.alter_column(u'schedule_jobcontrol', 'job_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'JobControl.job_name'
        db.alter_column(u'schedule_jobcontrol', 'job_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'schedule.jobcontrol': {
            ...
            'job_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
