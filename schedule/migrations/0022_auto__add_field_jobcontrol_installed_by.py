...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobControl.installed_by'
        db.add_column(u'schedule_jobcontrol', 'installed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobControl.installed_by'
        db.delete_column(u'schedule_jobcontrol', 'installed_by_id')
