...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.customer'
        db.alter_column(u'schedule_job', 'customer', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Job.cab_designation'
        db.alter_column(u'schedule_job', 'cab_designation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Job.po_number'
        db.alter_column(u'schedule_job', 'po_number', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Job.job_number'
        db.alter_column(u'schedule_job', 'job_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Job.customer'
        db.alter_column(u'schedule_job', 'customer', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Job.cab_designation'
        db.alter_column(u'schedule_job', 'cab_designation', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Job.po_number'
        db.alter_column(u'schedule_job', 'po_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Job.job_number'
        db.alter_column(u'schedule_job', 'job_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
