...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'schedule_job', 'contact_email', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
        # Adding field 'JobStatus.tssa_submitted_date'
        db.add_column(u'schedule_jobstatus', 'tssa_submitted_date',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobStatus.tssa_submitted_date_is_done'
        db.add_column(u'schedule_jobstatus', 'tssa_submitted_date_is_done',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobStatus.tssa_submitted_date_comment'
        db.add_column(u'schedule_jobstatus', 'tssa_submitted_date_comment',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Job.contact_email'
        db.alter_column(u'schedule_job', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
        # Deleting field 'JobStatus.tssa_submitted_date'
        db.delete_column(u'schedule_jobstatus', 'tssa_submitted_date')

        # Deleting field 'JobStatus.tssa_submitted_date_is_done'
        db.delete_column(u'schedule_jobstatus', 'tssa_submitted_date_is_done')

        # Deleting field 'JobStatus.tssa_submitted_date_comment'
        db.delete_column(u'schedule_jobstatus', 'tssa_submitted_date_comment')
