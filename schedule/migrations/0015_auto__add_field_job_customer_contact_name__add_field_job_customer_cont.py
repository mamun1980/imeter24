...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.customer_contact_name'
        db.add_column(u'schedule_job', 'customer_contact_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Job.customer_contact_phone_number'
        db.add_column(u'schedule_job', 'customer_contact_phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Comment.job_comment'
        db.alter_column(u'schedule_comment', 'job_comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'Comment.datetime'
        db.alter_column(u'schedule_comment', 'datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Job.customer_contact_name'
        db.delete_column(u'schedule_job', 'customer_contact_name')

        # Deleting field 'Job.customer_contact_phone_number'
        db.delete_column(u'schedule_job', 'customer_contact_phone_number')


        # Changing field 'Comment.job_comment'
        db.alter_column(u'schedule_comment', 'job_comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Comment.datetime'
        db.alter_column(u'schedule_comment', 'datetime', self.gf('django.db.models.fields.DateTimeField')())
