...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'schedule_comment', 'datetime',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'schedule_comment', 'datetime')
    ...
    models = {
        u'schedule.comment': {
            ...
            'job_comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
