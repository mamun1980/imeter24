...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Job.search_string'
        db.alter_column(u'schedule_job', 'search_string', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))
    ...
    models = {
        u'schedule.job': {
            ...
            'search_string': ('django.db.models.fields.TextField', [], {'max_length': '800', 'null': 'True', 'blank': 'True'}),
