...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.job_name'
        db.alter_column(u'schedule_job', 'job_name', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Job.job_name'
        db.alter_column(u'schedule_job', 'job_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
