...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobStatus.safety_test_schedule_date'
        db.add_column(u'schedule_jobstatus', 'safety_test_schedule_date',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobStatus.who_will_test'
        db.add_column(u'schedule_jobstatus', 'who_will_test',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobStatus.test_comment'
        db.add_column(u'schedule_jobstatus', 'test_comment',
                      self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobStatus.safety_test_schedule_date'
        db.delete_column(u'schedule_jobstatus', 'safety_test_schedule_date')

        # Deleting field 'JobStatus.who_will_test'
        db.delete_column(u'schedule_jobstatus', 'who_will_test')

        # Deleting field 'JobStatus.test_comment'
        db.delete_column(u'schedule_jobstatus', 'test_comment')
