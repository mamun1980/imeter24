...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'job_control'
        db.delete_table(u'schedule_job_control')
        ...
        db.create_table(u'schedule_jobcontrol', (
            ...
            ('elevetor_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Adding model 'job_control'
        db.create_table(u'schedule_job_control', (
            ('job_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('capacity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('rgw', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ...
            ('customer_po_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('job_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('sold_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job-control-sold_to', null=True, to=orm['contacts.Contact'], blank=True)),
            ('rear', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('ship_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job-control-ship_to', null=True, to=orm['contacts.Contact'], blank=True)),
            ('front', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('elevetor_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('installed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'schedule', ['job_control'])
    ...
    models = {
        ...
        u'schedule.jobcontrol': {
            ...
            'elevetor_type': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
