...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.invoiced_by'
        db.add_column(u'purchase_invoice', 'invoiced_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invoiced_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.invoiced_by'
        db.delete_column(u'purchase_invoice', 'invoiced_by_id')
