...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.hst_taxable'
        db.add_column(u'purchase_purchaseorder', 'hst_taxable',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.hst_taxable'
        db.delete_column(u'purchase_purchaseorder', 'hst_taxable')
