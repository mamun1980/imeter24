...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackingItem.ship_status'
        db.delete_column(u'purchase_packingitem', 'ship_status')


    def backwards(self, orm):
        # Adding field 'PackingItem.ship_status'
        db.add_column(u'purchase_packingitem', 'ship_status',
