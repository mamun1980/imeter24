...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackingItem.status'
        db.delete_column(u'purchase_packingitem', 'status')

        # Deleting field 'PackingItem.qty_bo'
        db.delete_column(u'purchase_packingitem', 'qty_bo')

        # Deleting field 'PackingItem.search_string'
        db.delete_column(u'purchase_packingitem', 'search_string')

        # Deleting field 'PackingItem.sl_item'
        db.delete_column(u'purchase_packingitem', 'sl_item_id')

        # Adding field 'PackingItem.line_comments'
        db.add_column(u'purchase_packingitem', 'line_comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PackingItem.status'
        db.add_column(u'purchase_packingitem', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PackingItem.qty_bo'
        db.add_column(u'purchase_packingitem', 'qty_bo',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'PackingItem.search_string'
        db.add_column(u'purchase_packingitem', 'search_string',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'PackingItem.line_comments'
        db.delete_column(u'purchase_packingitem', 'line_comments')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
