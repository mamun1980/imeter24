...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackingList.invoiced_on_date'
        db.add_column(u'purchase_packinglist', 'invoiced_on_date',
        ...
        # Adding field 'PackingList.shipping_comment'
        db.add_column(u'purchase_packinglist', 'shipping_comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackingList.invoiced_on_date'
        db.delete_column(u'purchase_packinglist', 'invoiced_on_date')

        # Deleting field 'PackingList.invoiced_on'
        db.delete_column(u'purchase_packinglist', 'invoiced_on')

        # Deleting field 'PackingList.shipping_comment'
        db.delete_column(u'purchase_packinglist', 'shipping_comment')
