...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseItem.cost'
        db.delete_column(u'purchase_purchaseitem', 'cost')

        # Deleting field 'PurchaseItem.item_recv'
        db.delete_column(u'purchase_purchaseitem', 'item_recv')

        # Deleting field 'PurchaseItem.sub_total'
        db.delete_column(u'purchase_purchaseitem', 'sub_total')


    def backwards(self, orm):
        # Adding field 'PurchaseItem.cost'
        db.add_column(u'purchase_purchaseitem', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseItem.item_recv'
        db.add_column(u'purchase_purchaseitem', 'item_recv',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseItem.sub_total'
        db.add_column(u'purchase_purchaseitem', 'sub_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'purchase.packingitem': {
            ...
            'qty_ordered': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'qty_shipped': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'search_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
