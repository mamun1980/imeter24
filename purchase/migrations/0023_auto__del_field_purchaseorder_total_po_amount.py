...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseOrder.total_po_amount'
        db.delete_column(u'purchase_purchaseorder', 'total_po_amount')


    def backwards(self, orm):
        # Adding field 'PurchaseOrder.total_po_amount'
        db.add_column(u'purchase_purchaseorder', 'total_po_amount',
