...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.po'
        db.add_column(u'purchase_purchaseitem', 'po',
    ...
    def backwards(self, orm):
        # Deleting field 'PurchaseItem.po'
        db.delete_column(u'purchase_purchaseitem', 'po_id')
        ...
        # Changing field 'PurchaseOrder.items_total'
        db.alter_column(u'purchase_purchaseorder', 'items_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=0))
    ...
    models = {
        ...
        u'purchase.purchaseitem': {
            ...
            'qty': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '0', 'blank': 'True'}),
            'search_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
