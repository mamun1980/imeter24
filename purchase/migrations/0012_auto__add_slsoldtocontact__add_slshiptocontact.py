...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SLSoldToContact'
        db.create_table(u'purchase_slsoldtocontact', (
        ...
        db.send_create_signal(u'purchase', ['SLSoldToContact'])

        # Adding model 'SLShipToContact'
        db.create_table(u'purchase_slshiptocontact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sl', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.ShippingList'], null=True, blank=True)),
            ('contact_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('contact', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'purchase', ['SLShipToContact'])


    def backwards(self, orm):
        # Deleting model 'SLSoldToContact'
        db.delete_table(u'purchase_slsoldtocontact')

        # Deleting model 'SLShipToContact'
        db.delete_table(u'purchase_slshiptocontact')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
