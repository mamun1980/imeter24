...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.po_total_before_tax'
        db.add_column(u'purchase_purchaseorder', 'po_total_before_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.po_total_before_tax'
        db.delete_column(u'purchase_purchaseorder', 'po_total_before_tax')
