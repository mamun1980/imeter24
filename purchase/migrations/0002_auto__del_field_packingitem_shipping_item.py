...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackingItem.shipping_item'
        db.delete_column(u'purchase_packingitem', 'shipping_item_id')


    def backwards(self, orm):
        # Adding field 'PackingItem.shipping_item'
        db.add_column(u'purchase_packingitem', 'shipping_item',
