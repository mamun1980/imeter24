...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'purchase_invoiceditem', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PackingItem'], null=True, blank=True)),
        ...
        db.create_table(u'purchase_invoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice_number', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True, blank=True)),
        ...
        # Changing field 'RequestItem.approved_qty'
        db.alter_column(u'purchase_requestitem', 'approved_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'RequestItem.total_po_qty'
        db.alter_column(u'purchase_requestitem', 'total_po_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PackingList.freight_charges'
        db.alter_column(u'purchase_packinglist', 'freight_charges', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PurchaseOrder.items_total'
        db.alter_column(u'purchase_purchaseorder', 'items_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PurchaseRequest.approved_qty'
        db.alter_column(u'purchase_purchaserequest', 'approved_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PurchaseRequest.order_qty'
        db.alter_column(u'purchase_purchaserequest', 'order_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RequestItem.approved_qty'
        db.alter_column(u'purchase_requestitem', 'approved_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'RequestItem.total_po_qty'
        db.alter_column(u'purchase_requestitem', 'total_po_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PackingList.freight_charges'
        db.alter_column(u'purchase_packinglist', 'freight_charges', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PurchaseOrder.items_total'
        db.alter_column(u'purchase_purchaseorder', 'items_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PurchaseRequest.approved_qty'
        db.alter_column(u'purchase_purchaserequest', 'approved_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PurchaseRequest.order_qty'
        db.alter_column(u'purchase_purchaserequest', 'order_qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'purchase.invoice': {
            ...
            'invoice_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'purchase.invoiceditem': {
            ...
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['purchase.PackingItem']", 'null': 'True', 'blank': 'True'}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
