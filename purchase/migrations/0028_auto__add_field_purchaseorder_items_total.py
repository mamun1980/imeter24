...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.items_total'
        db.add_column(u'purchase_purchaseorder', 'items_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.items_total'
        db.delete_column(u'purchase_purchaseorder', 'items_total')
