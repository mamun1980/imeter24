...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.discount_type'
        db.add_column(u'purchase_invoice', 'discount_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.discount_type'
        db.delete_column(u'purchase_invoice', 'discount_type')
