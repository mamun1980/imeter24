...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackingList.search_string'
        db.add_column(u'purchase_packinglist', 'search_string',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackingList.search_string'
        db.delete_column(u'purchase_packinglist', 'search_string')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 4, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
