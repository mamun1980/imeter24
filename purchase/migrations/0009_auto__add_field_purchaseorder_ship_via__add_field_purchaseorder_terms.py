...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.ship_via'
        db.add_column(u'purchase_purchaseorder', 'ship_via',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='po_shipping_method', null=True, to=orm['contacts.DeliveryChoice']),
                      keep_default=False)

        # Adding field 'PurchaseOrder.terms'
        db.add_column(u'purchase_purchaseorder', 'terms',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='po_payment_terms', null=True, to=orm['contacts.PaymentTerm']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.ship_via'
        db.delete_column(u'purchase_purchaseorder', 'ship_via_id')

        # Deleting field 'PurchaseOrder.terms'
        db.delete_column(u'purchase_purchaseorder', 'terms_id')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
