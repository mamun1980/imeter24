...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InvoicedItem.item'
        db.delete_column(u'purchase_invoiceditem', 'item_id')

        # Adding field 'InvoicedItem.sub_total'
        db.add_column(u'purchase_invoiceditem', 'sub_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InvoicedItem.item'
        db.add_column(u'purchase_invoiceditem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PackingItem'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvoicedItem.sub_total'
        db.delete_column(u'purchase_invoiceditem', 'sub_total')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
