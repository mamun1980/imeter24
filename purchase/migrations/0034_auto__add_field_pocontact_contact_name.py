...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'POContact.contact_name'
        db.add_column(u'purchase_pocontact', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'POContact.contact_name'
        db.delete_column(u'purchase_pocontact', 'contact_name')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
