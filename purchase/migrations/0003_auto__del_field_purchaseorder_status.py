...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseOrder.status'
        db.delete_column(u'purchase_purchaseorder', 'status')


    def backwards(self, orm):
        # Adding field 'PurchaseOrder.status'
        db.add_column(u'purchase_purchaseorder', 'status',
