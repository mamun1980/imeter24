...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackingList.invoiced_on'
        db.delete_column(u'purchase_packinglist', 'invoiced_on')

        # Deleting field 'PackingList.nel_packing_slip'
        db.delete_column(u'purchase_packinglist', 'nel_packing_slip')

        # Deleting field 'PackingList.search_string'
        db.delete_column(u'purchase_packinglist', 'search_string')

        # Adding field 'PackingList.shipping_bl_number'
        db.add_column(u'purchase_packinglist', 'shipping_bl_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PackingList.invoiced_on'
        db.add_column(u'purchase_packinglist', 'invoiced_on',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackingList.nel_packing_slip'
        db.add_column(u'purchase_packinglist', 'nel_packing_slip',
        ...
        # Deleting field 'PackingList.shipping_bl_number'
        db.delete_column(u'purchase_packinglist', 'shipping_bl_number')
