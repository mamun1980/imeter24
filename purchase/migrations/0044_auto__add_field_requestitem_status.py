...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestItem.status'
        db.add_column(u'purchase_requestitem', 'status',
                      self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequestItem.status'
        db.delete_column(u'purchase_requestitem', 'status')
