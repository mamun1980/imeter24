...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingList.sl_status'
        db.add_column(u'purchase_shippinglist', 'sl_status',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackingList.sl_number'
        db.add_column(u'purchase_packinglist', 'sl_number',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pl-to-sl', to=orm['purchase.ShippingList']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingList.sl_status'
        db.delete_column(u'purchase_shippinglist', 'sl_status')

        # Deleting field 'PackingList.sl_number'
        db.delete_column(u'purchase_packinglist', 'sl_number_id')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
