...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'purchase_packinglist', 'sl_number',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.ShippingList'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'purchase.packinglist': {
            ...
            'sl_number': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['purchase.ShippingList']", 'null': 'True', 'blank': 'True'}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
