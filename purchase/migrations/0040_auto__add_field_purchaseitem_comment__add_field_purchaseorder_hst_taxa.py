...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.comment'
        db.add_column(u'purchase_purchaseitem', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseOrder.hst_taxable_amount'
        db.add_column(u'purchase_purchaseorder', 'hst_taxable_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseOrder.pst_taxable_amount'
        db.add_column(u'purchase_purchaseorder', 'pst_taxable_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseItem.comment'
        db.delete_column(u'purchase_purchaseitem', 'comment')

        # Deleting field 'PurchaseOrder.hst_taxable_amount'
        db.delete_column(u'purchase_purchaseorder', 'hst_taxable_amount')

        # Deleting field 'PurchaseOrder.pst_taxable_amount'
        db.delete_column(u'purchase_purchaseorder', 'pst_taxable_amount')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
