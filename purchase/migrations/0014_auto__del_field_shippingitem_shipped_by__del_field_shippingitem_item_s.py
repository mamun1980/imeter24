...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShippingItem.item_ship_status'
        db.delete_column(u'purchase_shippingitem', 'item_ship_status')

        # Deleting field 'ShippingItem.shipped'
        db.delete_column(u'purchase_shippingitem', 'shipped')

        # Deleting field 'ShippingItem.last_shipped'
        db.delete_column(u'purchase_shippingitem', 'last_shipped')

        # Deleting field 'ShippingItem.filled'
        db.delete_column(u'purchase_shippingitem', 'filled')


    def backwards(self, orm):
        # Adding field 'ShippingItem.shipped_by'
        db.add_column(u'purchase_shippingitem', 'shipped_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='item_shipped_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'ShippingItem.item_ship_status'
        db.add_column(u'purchase_shippingitem', 'item_ship_status',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShippingItem.shipped'
        db.add_column(u'purchase_shippingitem', 'shipped',
        ...
        # Adding field 'ShippingItem.filled'
        db.add_column(u'purchase_shippingitem', 'filled',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
