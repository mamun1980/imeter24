...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.ship_via'
        db.add_column(u'purchase_invoice', 'ship_via',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invoice_shipping_method', null=True, to=orm['contacts.DeliveryChoice']),
                      keep_default=False)

        # Adding field 'Invoice.po'
        db.add_column(u'purchase_invoice', 'po',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='purchase-order', null=True, to=orm['purchase.PurchaseOrder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.ship_via'
        db.delete_column(u'purchase_invoice', 'ship_via_id')

        # Deleting field 'Invoice.po'
        db.delete_column(u'purchase_invoice', 'po_id')
    ...
    models = {
        ...
        u'purchase.invoice': {
            ...
            'po': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'purchase-order'", 'null': 'True', 'to': u"orm['purchase.PurchaseOrder']"}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
