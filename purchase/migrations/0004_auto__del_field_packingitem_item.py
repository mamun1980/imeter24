...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'purchase_packingitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='packing-item', null=True, to=orm['inventory.Item'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
