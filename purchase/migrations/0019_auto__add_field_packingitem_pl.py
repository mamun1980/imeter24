...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackingItem.pl'
        db.add_column(u'purchase_packingitem', 'pl',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PackingList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackingItem.pl'
        db.delete_column(u'purchase_packingitem', 'pl_id')
