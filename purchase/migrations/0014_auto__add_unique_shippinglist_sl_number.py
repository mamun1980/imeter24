...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ShippingList', fields ['sl_number']
        db.create_unique(u'purchase_shippinglist', ['sl_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'ShippingList', fields ['sl_number']
        db.delete_unique(u'purchase_shippinglist', ['sl_number'])
