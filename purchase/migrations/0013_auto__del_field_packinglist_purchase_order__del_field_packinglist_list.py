...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackingList.purchase_order'
        db.delete_column(u'purchase_packinglist', 'purchase_order_id')

        # Deleting field 'PackingList.list_type'
        db.delete_column(u'purchase_packinglist', 'list_type')

        # Adding field 'PackingList.order_type'
        db.add_column(u'purchase_packinglist', 'order_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackingList.customer_broker'
        db.add_column(u'purchase_packinglist', 'customer_broker',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pl_customer_broker', null=True, to=orm['contacts.Contact']),
                      keep_default=False)

        # Adding field 'PackingList.customer_po_number'
        db.add_column(u'purchase_packinglist', 'customer_po_number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PackingList.purchase_order'
        db.add_column(u'purchase_packinglist', 'purchase_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PurchaseOrder'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackingList.list_type'
        db.add_column(u'purchase_packinglist', 'list_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PackingList.order_type'
        db.delete_column(u'purchase_packinglist', 'order_type')

        # Deleting field 'PackingList.customer_broker'
        db.delete_column(u'purchase_packinglist', 'customer_broker_id')

        # Deleting field 'PackingList.customer_po_number'
        db.delete_column(u'purchase_packinglist', 'customer_po_number')
    ...
    models = {
        ...
        u'purchase.packingitem': {
            ...
            'ordered': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'qty_bo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'ship_status': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'shipped': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'})
        },
        u'purchase.packinglist': {
            ...
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['purchase.PackingItem']", 'null': 'True', 'blank': 'True'}),
            ...
            'packing_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'search_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'purchase.purchaseorder': {
            ...
            'total_po_amount': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'})
        },
        ...
        u'purchase.shippinglist': {
            ...
            'sl_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
