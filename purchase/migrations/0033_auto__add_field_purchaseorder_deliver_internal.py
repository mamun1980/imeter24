...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.deliver_internal'
        db.add_column(u'purchase_purchaseorder', 'deliver_internal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.DeliverInternal'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.deliver_internal'
        db.delete_column(u'purchase_purchaseorder', 'deliver_internal_id')
