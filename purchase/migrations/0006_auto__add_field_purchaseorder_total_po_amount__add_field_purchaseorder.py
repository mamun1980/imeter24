...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PurchaseOrder.po_currency'
        db.add_column(u'purchase_purchaseorder', 'po_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(max_length=20, to=orm['contacts.Currency'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PurchaseOrder.po_currency'
        db.delete_column(u'purchase_purchaseorder', 'po_currency_id')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
