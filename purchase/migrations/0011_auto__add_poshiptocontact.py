...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'POShipToContact'
        db.create_table(u'purchase_poshiptocontact', (
        ...
        db.send_create_signal(u'purchase', ['POShipToContact'])


    def backwards(self, orm):
        # Deleting model 'POShipToContact'
        db.delete_table(u'purchase_poshiptocontact')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
