...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'POContact.purchase_order' to match new field type.
        db.rename_column(u'purchase_pocontact', 'purchase_order', 'purchase_order_id')
        # Changing field 'POContact.purchase_order'
        db.alter_column(u'purchase_pocontact', 'purchase_order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PurchaseOrder'], null=True))
        # Adding index on 'POContact', fields ['purchase_order']
        db.create_index(u'purchase_pocontact', ['purchase_order_id'])


    def backwards(self, orm):
        # Removing index on 'POContact', fields ['purchase_order']
        db.delete_index(u'purchase_pocontact', ['purchase_order_id'])


        # Renaming column for 'POContact.purchase_order' to match new field type.
        db.rename_column(u'purchase_pocontact', 'purchase_order_id', 'purchase_order')
        # Changing field 'POContact.purchase_order'
        db.alter_column(u'purchase_pocontact', 'purchase_order', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
