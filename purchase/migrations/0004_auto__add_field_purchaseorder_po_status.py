...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.po_status'
        db.add_column(u'purchase_purchaseorder', 'po_status',
                      self.gf('django.db.models.fields.CharField')(default='New', max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.po_status'
        db.delete_column(u'purchase_purchaseorder', 'po_status')
