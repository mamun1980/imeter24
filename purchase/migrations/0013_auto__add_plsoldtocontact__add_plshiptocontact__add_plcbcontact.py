...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PLSoldToContact'
        db.create_table(u'purchase_plsoldtocontact', (
        ...
        db.send_create_signal(u'purchase', ['PLSoldToContact'])

        # Adding model 'PLShipToContact'
        db.create_table(u'purchase_plshiptocontact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pl', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PackingList'], null=True, blank=True)),
            ('contact_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('contact', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'purchase', ['PLShipToContact'])

        # Adding model 'PLCBContact'
        db.create_table(u'purchase_plcbcontact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pl', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PackingList'], null=True, blank=True)),
            ('contact_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('contact', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'purchase', ['PLCBContact'])


    def backwards(self, orm):
        # Deleting model 'PLSoldToContact'
        db.delete_table(u'purchase_plsoldtocontact')

        # Deleting model 'PLShipToContact'
        db.delete_table(u'purchase_plshiptocontact')

        # Deleting model 'PLCBContact'
        db.delete_table(u'purchase_plcbcontact')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
