...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseOrder.next_number'
        db.delete_column(u'purchase_purchaseorder', 'next_number')


    def backwards(self, orm):
        # Adding field 'PurchaseOrder.next_number'
        db.add_column(u'purchase_purchaseorder', 'next_number',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=20, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
