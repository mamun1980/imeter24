...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingItem.shipped_total_to_date'
        db.add_column(u'purchase_shippingitem', 'shipped_total_to_date',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)

        # Adding field 'ShippingItem.shipped_by'
        db.add_column(u'purchase_shippingitem', 'shipped_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_shipped_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ShippingItem.last_shipped'
        db.add_column(u'purchase_shippingitem', 'last_shipped',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShippingItem.backordered'
        db.add_column(u'purchase_shippingitem', 'backordered',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingItem.shipped_total_to_date'
        db.delete_column(u'purchase_shippingitem', 'shipped_total_to_date')

        # Deleting field 'ShippingItem.shipped_by'
        db.delete_column(u'purchase_shippingitem', 'shipped_by_id')

        # Deleting field 'ShippingItem.last_shipped'
        db.delete_column(u'purchase_shippingitem', 'last_shipped')

        # Deleting field 'ShippingItem.backordered'
        db.delete_column(u'purchase_shippingitem', 'backordered')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'purchase.requestitem': {
            ...
            'total_po_qty': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'})
        },
        u'purchase.shippingitem': {
            'Meta': {'object_name': 'ShippingItem'},
            'backordered': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'shipped_total_to_date': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
