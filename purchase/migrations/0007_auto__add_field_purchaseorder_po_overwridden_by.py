...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.po_overwridden_by'
        db.add_column(u'purchase_purchaseorder', 'po_overwridden_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='po_overwridden_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.po_overwridden_by'
        db.delete_column(u'purchase_purchaseorder', 'po_overwridden_by_id')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
