...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShippingItem.required'
        db.delete_column(u'purchase_shippingitem', 'required')


    def backwards(self, orm):
        # Adding field 'ShippingItem.required'
        db.add_column(u'purchase_shippingitem', 'required',
