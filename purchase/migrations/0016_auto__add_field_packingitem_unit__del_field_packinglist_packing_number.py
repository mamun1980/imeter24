...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackingItem.unit'
        db.add_column(u'purchase_packingitem', 'unit',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PackingList.packing_number'
        db.delete_column(u'purchase_packinglist', 'packing_number')

        # Adding field 'PackingList.pl_number'
        db.add_column(u'purchase_packinglist', 'pl_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field items on 'PackingList'
        db.delete_table(db.shorten_name(u'purchase_packinglist_items'))


    def backwards(self, orm):
        # Deleting field 'PackingItem.unit'
        db.delete_column(u'purchase_packingitem', 'unit')

        # Adding field 'PackingList.packing_number'
        db.add_column(u'purchase_packinglist', 'packing_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PackingList.pl_number'
        db.delete_column(u'purchase_packinglist', 'pl_number')

        # Adding M2M table for field items on 'PackingList'
        m2m_table_name = db.shorten_name(u'purchase_packinglist_items')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('packinglist', models.ForeignKey(orm[u'purchase.packinglist'], null=False)),
            ('packingitem', models.ForeignKey(orm[u'purchase.packingitem'], null=False))
        ))
        db.create_unique(m2m_table_name, ['packinglist_id', 'packingitem_id'])
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
