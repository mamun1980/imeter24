...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseItem.qty'
        db.alter_column(u'purchase_purchaseitem', 'qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ReceivedItemHistory.sub_total'
        db.alter_column(u'purchase_receiveditemhistory', 'sub_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ReceivedItemHistory.qty_received'
        db.alter_column(u'purchase_receiveditemhistory', 'qty_received', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PackingItem.qty_bo'
        db.alter_column(u'purchase_packingitem', 'qty_bo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PackingItem.qty_shipped'
        db.alter_column(u'purchase_packingitem', 'qty_shipped', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'PackingItem.qty_ordered'
        db.alter_column(u'purchase_packingitem', 'qty_ordered', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ShippingItem.ordered'
        db.alter_column(u'purchase_shippingitem', 'ordered', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ShippingItem.required'
        db.alter_column(u'purchase_shippingitem', 'required', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ShippingItem.shipped'
        db.alter_column(u'purchase_shippingitem', 'shipped', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ShippingItem.filled'
        db.alter_column(u'purchase_shippingitem', 'filled', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'PurchaseItem.qty'
        db.alter_column(u'purchase_purchaseitem', 'qty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=0))

        # Changing field 'ReceivedItemHistory.sub_total'
        db.alter_column(u'purchase_receiveditemhistory', 'sub_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'ReceivedItemHistory.qty_received'
        db.alter_column(u'purchase_receiveditemhistory', 'qty_received', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PackingItem.qty_bo'
        db.alter_column(u'purchase_packingitem', 'qty_bo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PackingItem.qty_shipped'
        db.alter_column(u'purchase_packingitem', 'qty_shipped', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PackingItem.qty_ordered'
        db.alter_column(u'purchase_packingitem', 'qty_ordered', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'ShippingItem.ordered'
        db.alter_column(u'purchase_shippingitem', 'ordered', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'ShippingItem.required'
        db.alter_column(u'purchase_shippingitem', 'required', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'ShippingItem.shipped'
        db.alter_column(u'purchase_shippingitem', 'shipped', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'ShippingItem.filled'
        db.alter_column(u'purchase_shippingitem', 'filled', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'purchase.packingitem': {
            ...
            'qty_bo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'qty_ordered': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'qty_shipped': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'search_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ship_status': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        u'purchase.packinglist': {
            ...
            'freight_charges': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'pl_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'search_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'sl_number': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pl-to-sl'", 'to': u"orm['purchase.ShippingList']"}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'purchase.receiveditemhistory': {
            ...
            'qty_received': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
        ...
        u'purchase.shippingitem': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'filled': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'ordered': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'required': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
            'search_string': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'shipped': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4', 'blank': 'True'}),
        ...
        u'purchase.shippinglist': {
            ...
            'sl_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
