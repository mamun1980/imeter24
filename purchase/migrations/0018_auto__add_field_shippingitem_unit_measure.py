...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingItem.unit_measure'
        db.add_column(u'purchase_shippingitem', 'unit_measure',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingItem.unit_measure'
        db.delete_column(u'purchase_shippingitem', 'unit_measure')
