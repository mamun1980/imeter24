...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseRequest.user_requested'
        db.add_column(u'purchase_purchaserequest', 'user_requested',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='po_requested_user', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseRequest.user_requested'
        db.delete_column(u'purchase_purchaserequest', 'user_requested_id')
    ...
    models = {
        ...
        u'purchase.purchaseorder': {
            ...
            'items_total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '0', 'blank': 'True'}),
