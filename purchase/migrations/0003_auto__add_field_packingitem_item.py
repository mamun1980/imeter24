...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackingItem.item'
        db.add_column(u'purchase_packingitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='packing-item', null=True, to=orm['inventory.Item']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackingItem.item'
        db.delete_column(u'purchase_packingitem', 'item_id')
    ...
    models = {
        ...
        u'purchase.packingitem': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'packing-item'", 'null': 'True', 'to': u"orm['inventory.Item']"}),
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
