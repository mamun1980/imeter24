...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.custom_comment'
        db.add_column(u'purchase_purchaseitem', 'custom_comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseItem.custom_detail'
        db.add_column(u'purchase_purchaseitem', 'custom_detail',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseItem.custom_comment'
        db.delete_column(u'purchase_purchaseitem', 'custom_comment')

        # Deleting field 'PurchaseItem.custom_detail'
        db.delete_column(u'purchase_purchaseitem', 'custom_detail')
    ...
    models = {
        ...
        u'purchase.postatus': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
