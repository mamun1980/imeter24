...
class ShippingItem(models.Model):
	...
	shipped = models.DecimalField(max_digits=10,decimal_places=4, blank=True, null=True)
	required = models.DecimalField(max_digits=10,decimal_places=4, blank=True, null=True)
