...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.search_string'
        db.add_column(u'contacts_contact', 'search_string',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.search_string'
        db.delete_column(u'contacts_contact', 'search_string')
