...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Currency.currency_icon'
        db.add_column(u'contacts_currency', 'currency_icon',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Currency.currency_icon'
        db.delete_column(u'contacts_currency', 'currency_icon')
