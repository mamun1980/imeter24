...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactContactType.contact'
        db.alter_column(u'contacts_contactcontacttype', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContactContactType.contact'
        raise RuntimeError("Cannot reverse this migration. 'ContactContactType.contact' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ContactContactType.contact'
        db.alter_column(u'contacts_contactcontacttype', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact']))
