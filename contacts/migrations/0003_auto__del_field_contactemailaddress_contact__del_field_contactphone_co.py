...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContactEmailAddress.contact'
        db.delete_column(u'contacts_contactemailaddress', 'contact_id')

        # Deleting field 'ContactPhone.contact'
        db.delete_column(u'contacts_contactphone', 'contact_id')


    def backwards(self, orm):
        # Adding field 'ContactEmailAddress.contact'
        db.add_column(u'contacts_contactemailaddress', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['contacts.Contact']),
                      keep_default=False)

        # Adding field 'ContactPhone.contact'
        db.add_column(u'contacts_contactphone', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['contacts.Contact']),
                      keep_default=False)
