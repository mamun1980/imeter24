...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecuringReport.comment'
        db.add_column(u'report_recuringreport', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecuringReport.comment'
        db.delete_column(u'report_recuringreport', 'comment')
