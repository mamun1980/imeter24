...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.qty_received'
        db.add_column(u'inventory_item', 'qty_received',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.qty_received'
        db.delete_column(u'inventory_item', 'qty_received')
