...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.last_PO'
        db.add_column(u'inventory_item', 'last_PO',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.last_PO_date_ordered'
        db.add_column(u'inventory_item', 'last_PO_date_ordered',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.last_PO_date_expected'
        db.add_column(u'inventory_item', 'last_PO_date_expected',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.last_cost_paid'
        db.add_column(u'inventory_item', 'last_cost_paid',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Item.last_PO_ordered_by'
        db.add_column(u'inventory_item', 'last_PO_ordered_by',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.last_PO_supplier'
        db.add_column(u'inventory_item', 'last_PO_supplier',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_PO_supplier', null=True, to=orm['contacts.Contact']),
                      keep_default=False)

        # Adding field 'Item.lowest_price_supplier'
        db.add_column(u'inventory_item', 'lowest_price_supplier',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='economic_supplier', null=True, to=orm['contacts.Contact']),
                      keep_default=False)

        # Adding field 'Item.lowest_price_paid'
        db.add_column(u'inventory_item', 'lowest_price_paid',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Item.lowest_price_last_buy_date'
        db.add_column(u'inventory_item', 'lowest_price_last_buy_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.lowest_price_last_buy_PO'
        db.add_column(u'inventory_item', 'lowest_price_last_buy_PO',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.last_PO'
        db.delete_column(u'inventory_item', 'last_PO')

        # Deleting field 'Item.last_PO_date_ordered'
        db.delete_column(u'inventory_item', 'last_PO_date_ordered')

        # Deleting field 'Item.last_PO_date_expected'
        db.delete_column(u'inventory_item', 'last_PO_date_expected')

        # Deleting field 'Item.last_cost_paid'
        db.delete_column(u'inventory_item', 'last_cost_paid')

        # Deleting field 'Item.last_PO_ordered_by'
        db.delete_column(u'inventory_item', 'last_PO_ordered_by')

        # Deleting field 'Item.last_PO_supplier'
        db.delete_column(u'inventory_item', 'last_PO_supplier_id')

        # Deleting field 'Item.lowest_price_supplier'
        db.delete_column(u'inventory_item', 'lowest_price_supplier_id')

        # Deleting field 'Item.lowest_price_paid'
        db.delete_column(u'inventory_item', 'lowest_price_paid')

        # Deleting field 'Item.lowest_price_last_buy_date'
        db.delete_column(u'inventory_item', 'lowest_price_last_buy_date')

        # Deleting field 'Item.lowest_price_last_buy_PO'
        db.delete_column(u'inventory_item', 'lowest_price_last_buy_PO')
