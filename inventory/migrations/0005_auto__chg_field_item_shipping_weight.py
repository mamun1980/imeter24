...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.shipping_weight'
        db.alter_column(u'inventory_item', 'shipping_weight', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Item.shipping_weight'
        db.alter_column(u'inventory_item', 'shipping_weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
