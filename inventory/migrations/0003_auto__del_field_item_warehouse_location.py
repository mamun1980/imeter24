...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'inventory_item', 'warehouse_location_id')


    def backwards(self, orm):
        # Adding field 'Item.warehouse_location'
        db.add_column(u'inventory_item', 'warehouse_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Location'], null=True, blank=True),
                      keep_default=False)
