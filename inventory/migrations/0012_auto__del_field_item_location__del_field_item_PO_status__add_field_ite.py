...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'inventory_item', 'location')

        # Deleting field 'Item.PO_status'
        db.delete_column(u'inventory_item', 'PO_status')

        # Adding field 'Item.warehose_location'
        db.add_column(u'inventory_item', 'warehose_location',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'inventory_item', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.PO_status'
        db.add_column(u'inventory_item', 'PO_status',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Item.warehose_location'
        db.delete_column(u'inventory_item', 'warehose_location')
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'warehose_location': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
