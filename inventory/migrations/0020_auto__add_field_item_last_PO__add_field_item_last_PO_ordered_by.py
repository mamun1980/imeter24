...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'inventory_item', 'last_PO_ordered_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_PO_order_by', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'inventory_item', 'last_PO_ordered_by_id')
