...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.max_order_qty_remains'
        db.add_column(u'inventory_item', 'max_order_qty_remains',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.max_order_qty_remains'
        db.delete_column(u'inventory_item', 'max_order_qty_remains')
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'max_order_qty_remains': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
