...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.hst_taxable'
        db.add_column(u'inventory_item', 'hst_taxable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Item.pst_taxable'
        db.add_column(u'inventory_item', 'pst_taxable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.hst_taxable'
        db.delete_column(u'inventory_item', 'hst_taxable')

        # Deleting field 'Item.pst_taxable'
        db.delete_column(u'inventory_item', 'pst_taxable')
