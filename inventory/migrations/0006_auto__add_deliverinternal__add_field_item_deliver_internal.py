...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_deliverinternal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('department', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'inventory', ['DeliverInternal'])

        # Adding field 'Item.deliver_internal'
        db.add_column(u'inventory_item', 'deliver_internal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.DeliverInternal'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DeliverInternal'
        db.delete_table(u'inventory_deliverinternal')

        # Deleting field 'Item.deliver_internal'
        db.delete_column(u'inventory_item', 'deliver_internal_id')
