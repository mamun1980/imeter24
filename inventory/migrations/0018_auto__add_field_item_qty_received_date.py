...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.qty_received_date'
        db.add_column(u'inventory_item', 'qty_received_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.qty_received_date'
        db.delete_column(u'inventory_item', 'qty_received_date')
