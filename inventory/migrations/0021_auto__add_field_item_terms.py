...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.terms'
        db.add_column(u'inventory_item', 'terms',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_payment_terms', null=True, to=orm['contacts.PaymentTerm']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.terms'
        db.delete_column(u'inventory_item', 'terms_id')
