...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.warehouse_location'
        db.add_column(u'inventory_item', 'warehouse_location',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.warehouse_location'
        db.delete_column(u'inventory_item', 'warehouse_location')
