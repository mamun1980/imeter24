...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.search_string'
        db.add_column(u'inventory_item', 'search_string',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.search_string'
        db.delete_column(u'inventory_item', 'search_string')
