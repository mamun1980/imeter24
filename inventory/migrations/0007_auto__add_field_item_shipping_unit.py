...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.shipping_unit'
        db.add_column(u'inventory_item', 'shipping_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.shipping_unit'
        db.delete_column(u'inventory_item', 'shipping_unit')
