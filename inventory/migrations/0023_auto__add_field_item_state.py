...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.state'
        db.add_column(u'inventory_item', 'state',
                      self.gf('django_fsm.FSMField')(default='new', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.state'
        db.delete_column(u'inventory_item', 'state')
