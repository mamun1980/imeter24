...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Payroll', fields ['user']
        db.create_unique(u'scomuser_payroll', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Payroll', fields ['user']
        db.delete_unique(u'scomuser_payroll', ['user_id'])


        # Changing field 'Payroll.user'
        db.alter_column(u'scomuser_payroll', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
