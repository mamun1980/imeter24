...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Payroll.rate_of_pay'
        db.delete_column(u'scomuser_payroll', 'rate_of_pay')


    def backwards(self, orm):
        # Adding field 'Payroll.rate_of_pay'
        db.add_column(u'scomuser_payroll', 'rate_of_pay',
