...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScomUserProfile.internal_extension'
        db.add_column(u'scomuser_scomuserprofile', 'internal_extension',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScomUserProfile.search_string'
        db.add_column(u'scomuser_scomuserprofile', 'search_string',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ScomUserProfile.internal_extension'
        db.delete_column(u'scomuser_scomuserprofile', 'internal_extension')

        # Deleting field 'ScomUserProfile.search_string'
        db.delete_column(u'scomuser_scomuserprofile', 'search_string')
