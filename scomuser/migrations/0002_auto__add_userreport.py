...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scomuser_userreport', (
            ...
            ('report_printer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['report.Printer'], null=True, blank=True)),
    ...
    models = {
        ...
        u'scomuser.userreport': {
            ...
            'report_printer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['report.Printer']", 'null': 'True', 'blank': 'True'}),
