...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Controllers.ipaddress'
        db.alter_column(u'alarm_controllers', 'ipaddress', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Controllers.ipaddress'
        db.alter_column(u'alarm_controllers', 'ipaddress', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
