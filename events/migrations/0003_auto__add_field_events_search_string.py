...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.search_string'
        db.add_column(u'events_events', 'search_string',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.search_string'
        db.delete_column(u'events_events', 'search_string')
