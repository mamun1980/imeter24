...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Events.eventid'
        db.alter_column(u'events_events', 'eventid', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True))

        # Changing field 'Events.category'
        db.alter_column(u'events_events', 'category', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Events.name'
        db.alter_column(u'events_events', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Events.doorname'
        db.alter_column(u'events_events', 'doorname', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Events.cardnumber'
        db.alter_column(u'events_events', 'cardnumber', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Events.action'
        db.alter_column(u'events_events', 'action', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Events.event'
        db.alter_column(u'events_events', 'event', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Events.zonename'
        db.alter_column(u'events_events', 'zonename', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Events.eventid'
        db.alter_column(u'events_events', 'eventid', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True))

        # Changing field 'Events.category'
        db.alter_column(u'events_events', 'category', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Events.name'
        db.alter_column(u'events_events', 'name', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Events.doorname'
        db.alter_column(u'events_events', 'doorname', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Events.cardnumber'
        db.alter_column(u'events_events', 'cardnumber', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Events.action'
        db.alter_column(u'events_events', 'action', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Events.event'
        db.alter_column(u'events_events', 'event', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Events.zonename'
        db.alter_column(u'events_events', 'zonename', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
