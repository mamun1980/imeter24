...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SystemVariable.default_report_for_po'
        db.add_column(u'premierelevator_systemvariable', 'default_report_for_po',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_report_for_po', null=True, to=orm['report.Report']),
                      keep_default=False)

        # Adding field 'SystemVariable.default_report_for_sl'
        db.add_column(u'premierelevator_systemvariable', 'default_report_for_sl',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_report_for_sl', null=True, to=orm['report.Report']),
                      keep_default=False)

        # Adding field 'SystemVariable.default_report_for_pl'
        db.add_column(u'premierelevator_systemvariable', 'default_report_for_pl',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_report_for_pl', null=True, to=orm['report.Report']),
                      keep_default=False)

        # Adding field 'SystemVariable.default_report_for_invoice'
        db.add_column(u'premierelevator_systemvariable', 'default_report_for_invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_report_for_invoice', null=True, to=orm['report.Report']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SystemVariable.default_report_for_po'
        db.delete_column(u'premierelevator_systemvariable', 'default_report_for_po_id')

        # Deleting field 'SystemVariable.default_report_for_sl'
        db.delete_column(u'premierelevator_systemvariable', 'default_report_for_sl_id')

        # Deleting field 'SystemVariable.default_report_for_pl'
        db.delete_column(u'premierelevator_systemvariable', 'default_report_for_pl_id')

        # Deleting field 'SystemVariable.default_report_for_invoice'
        db.delete_column(u'premierelevator_systemvariable', 'default_report_for_invoice_id')
