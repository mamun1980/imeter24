...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SystemVariable.default_printer_for_user'
        db.add_column(u'premierelevator_systemvariable', 'default_printer_for_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_printer_for_user', null=True, to=orm['report.Printer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SystemVariable.default_printer_for_user'
        db.delete_column(u'premierelevator_systemvariable', 'default_printer_for_user_id')
